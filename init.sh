...
run_cmd "sudo apt-get -y install gcc make cmake gettext git curl bat ripgrep stow nodejs golang python3-pip python3-venv kitty zsh btop" "[apt] Install tools"
